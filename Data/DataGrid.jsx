                ...
                switch (fixed){
                    case "fixedLeft":
                        trobj.push(<tr ref="fixedLeftDetail" key={this.state.detailIndex+"detail"} style={{borderLeft:"1px solid #e7e7e7"}}>
                            <td colSpan={colSpan}><div className="wasabi-detail" ><div ref="fixedLeftWasabiDetailWrap"  className="wasabi-detail-Wrap">{this.state.detailView}</div></div></td>
                        </tr>);
                        break;
                    case "fixedRight":
                        trobj.push(<tr ref="fixedRightDetail" key={this.state.detailIndex+"detail"} style={{borderLeft:"1px solid #e7e7e7"}}>
                            <td colSpan={colSpan}><div className="wasabi-detail" ><div ref="fixedRightWasabiDetailWrap"  className="wasabi-detail-Wrap">{this.state.detailView}</div></div></td>
                        </tr>);
                        break;
                    default:
